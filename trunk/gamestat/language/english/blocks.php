...
* @version		$Id$
*/
define ("_MB_GAMESTAT_YES", "Yes");
define ("_MB_GAMESTAT_NO", "No");
define ("_MB_GAMESTAT_NOBODY", "Nobody is online.");
define ("_MB_GAMESTAT_ONEP", " Gamer is online.");
define ("_MB_GAMESTAT_MULTIP", " Gamer are online.");

define ("_MB_GAMESTAT_STATUS_IPFQDN", "IP Adresse/Name: ");
define ("_MB_GAMESTAT_STATUS_PORT", "Port #: ");

define ("_MB_GAMESTAT_BLOCK_INFO_SMALL", "This is a small block. We recommend as <b>Blocktype:</b> <i>Site Block - Left</i> or <i>Site Block - Right</i>. ");
define ("_MB_GAMESTAT_BLOCK_INFO_BIG", "This is a big block. We recommend as <b>Blocktype:</b> <i>Center Block - Center</i>. ");
define ("_MB_GAMESTAT_STATUS_OPTA", "Show Array Dump? ");
define ("_MB_GAMESTAT_STATUS_OPTB", "Game Identifier ");
...
define ("_MB_GAMESTAT_SVRONLINE_IMG", "../gamestat/language/english/images/svronline.png");

define ("_MB_GAMESTAT_SVROFFLINE_TXT", "Server Offline");
define ("_MB_GAMESTAT_SVROFFLINE_IMG", "../gamestat/language/english/images/svroffline.png");

// Items referenced in multiple block templates.
define ("_MB_GAMESTAT_BLOCK_ERROR", "Error: ");
define ("_MB_GAMESTAT_BLOCK_MAP", "Map:");
...
define ("_MB_SERVER_GAME_VERSION", "Version:");
define ("_MB_SERVER_CURRENT_MOD", "Current Mod:");
define ("_MB_SERVER_GAME_TYPE", "Aktueller Game Type:");
define ("_MB_SERVER_CURRENT_MAP", "Current Map:");
define ("_MB_SERVER_TEAM_1", "Team 1:");
define ("_MB_SERVER_TEAM_2", "Team 2:");
define ("_MB_SERVER_MAX_PLAYER", "Max. Players:");
define ("_MB_SERVER_CURRENT_PLAYER", "Current Players:");
define ("_MB_SERVER_ROUNDS", "Rounds:");
define ("_MB_SERVER_CURRENT_ROUND", "Aktuelle Runde:");
define ("_MB_SERVER_FRAGLIMIT", "Fraglimit:");
define ("_MB_SERVER_TIMELIMIT", "Time Limit:");
define ("_MB_SERVER_TIMELIMIT_NO", "No Limit");
define ("_MB_SERVER_TIMELIMIT_MINUTE", "Minutes");
define ("_MB_SERVER_MODE", "Modus:");
...
define ("_MB_SERVER_PLAYER_HONOR", "Honor");
define ("_MB_SERVER_PLAYER_PING", "Ping");
define ("_MB_SERVER_PLAYER_FRAGS", "Frags");
define ("_MB_SERVER_TEAM_FLAG", "Flag");
define ("_MB_SERVER_YES", "Yes");
define ("_MB_SERVER_NO", "No");
define ("_MB_SERVER_LOGGED", "Server with password");
define ("_MB_SERVER_NO_MAP_IMAGE", "No Map-Image available");
define ("_MB_SERVER_PLAYER", "Player");
define ("_MB_SERVER_ADDITION", "Other game-specific data are currently unavailable.");
define ("_MB_SERVER_NUMBOTS", "Bots:");
define ("_MB_SERVER_BOT_SKILL", "Bot Skill:");
define ("_MB_SERVER_STOCK_MUTATORS", "Mutator:");
define ("_MB_SERVER_OFFICIAL", "Official Server:");

// Graphics
define ("_MB_GRAPHICS_BY", "Icon of");
